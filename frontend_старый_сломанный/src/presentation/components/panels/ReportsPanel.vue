<template>
  <div class="h-full flex flex-col p-4 bg-gray-800 rounded-lg">
    ...
    <div class="flex-grow overflow-y-auto">
      ...
      <div v-else-if="reports.length === 0" class="text-center text-gray-400">
...
import { useReportsPanelService } from '@/composables/useReportsPanelService';
