...
export interface ProjectRepository {
   ...
   */
  getRecentProjects(): Promise<Array<{id: string; name: string; path: string; lastOpened: string}>>;

  /**
   * Add project to recent projects list
   * @param project Project to add
   */
  addToRecentProjects(project: {id: string; name: string; path: string}): Promise<void>;

  /**
   * Remove project from recent projects list
   * @param projectId Project ID to remove
   */
  removeFromRecentProjects(projectId: string): Promise<void>;
