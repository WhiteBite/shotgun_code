...
import { ToastNotificationAdapter } from '@/infrastructure/api/adapters'

const projectStore = useProjectStore()
const globalError = ref<string | null>(null)
const notificationPort = new ToastNotificationAdapter()
const memoryMonitor = useMemoryMonitor(notificationPort, {
