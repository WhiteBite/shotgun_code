...
describe('useHoveredFile', () => {
    ...
    it('should create hovered file state with initial null values', async () => {
        ...
        expect(state.path.value).toBeNull()
        expect(state.isDir.value).toBeNull()
    })
    ...
    it('should set hovered file path and isDir', async () => {
        ...
        state.setHovered('/path/to/file.ts', false)

        expect(state.path.value).toBe('/path/to/file.ts')
        expect(state.isDir.value).toBe(false)
    })
    ...
    it('should set hovered directory', async () => {
        ...
        state.setHovered('/path/to/folder', true)

        expect(state.path.value).toBe('/path/to/folder')
        expect(state.isDir.value).toBe(true)
    })
    ...
    it('should clear hovered state when path matches', async () => {
        ...
        state.setHovered('/path/to/file.ts', false)
        state.clearHovered('/path/to/file.ts')
    ...
    it('should not clear hovered state when path does not match', async () => {
        ...
        state.setHovered('/path/to/file.ts', false)
        state.clearHovered('/different/path.ts')
