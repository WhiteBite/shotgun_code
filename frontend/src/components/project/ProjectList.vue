<template>
  <div class="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
    ...
    <div class="space-y-3">
      <!-- Кнопка выбора папки -->
      <button @click="projectStore.selectProjectFromDialog()" class="w-full flex items-center justify-center gap-2 p-3 bg-blue-600/80 hover:bg-blue-600 rounded-md text-white font-semibold transition-colors">
