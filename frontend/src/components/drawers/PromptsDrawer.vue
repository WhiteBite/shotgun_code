<template>
  <transition name="slide-fade">
    <aside v-if="uiStore.activeDrawer === 'prompts'" class="absolute top-0 right-0 h-full w-96 bg-gray-800 border-l border-gray-700 shadow-2xl z-30 p-4 flex flex-col">
