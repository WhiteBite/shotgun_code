<template>
  <div class="h-16 bg-gray-800 border-t border-gray-700 flex-shrink-0 flex items-center justify-between px-4 text-sm text-gray-300">
    <div class="flex items-center gap-4">
      <button @click="uiStore.toggleConsole()" class="p-2 rounded-md hover:bg-gray-700" title="Toggle Console">
    ...
    <div class="flex items-center gap-3">
      <button
          ...
          :disabled="contextStore.selectedFiles.length === 0 || uiStore.progress.isActive"
