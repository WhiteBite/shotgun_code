      ...
      <div class="p-4">
        <div class="flex items-start">
          ...
          <div class="ml-3 flex-1 pt-0.5">
            <p class="text-sm font-medium text-white whitespace-normal break-words">
              {{ toast.message }}
            </p>
          </div>
          <div class="ml-4 flex-shrink-0 flex">
            <button @click="emit('close')" class="bg-gray-800 rounded-md inline-flex text-gray-400 hover:text-gray-200">
