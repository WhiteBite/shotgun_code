          ...
          <div class="flex items-center w-full">
            ...
            >
              <div
                  ...
                  steps.currentStep === step.id ? 'border-blue-600 bg-blue-100 text-blue-700' :
              ...
              >
                <span v-if="!(step.completed && steps.currentStep !== step.id)">{{ step.id }}</span>
              ...
              <span :class="['whitespace-nowrap', steps.currentStep === step.id ? 'text-blue-600 font-semibold' : (step.completed ? 'text-green-600' : 'text-gray-500 group-hover:text-gray-700')]">
                {{ step.title }}
              </span>
            </button>
          </div>
