          ...
          <div class="flex-1 overflow-y-auto p-6">
            ...
            <div v-if="selectedMode === 'clipboard'" class="space-y-4">
              ...
              <label class="flex items-center gap-2 text-sm text-gray-300 cursor-pointer">
                <input
                  v-model="settings.stripComments"
                  type="checkbox"
              ...
              <label class="flex items-center gap-2 text-sm text-gray-300 cursor-pointer">
                <input
                  v-model="settings.includeManifest"
                  type="checkbox"
                  class="w-4 h-4 rounded border-gray-600 bg-gray-800 text-blue-500 focus:ring-0"
                />
            ...
            <div v-if="selectedMode === 'ai'" class="space-y-4">
              ...
              <div>
                ...
                <input
                  v-model.number="settings.tokenLimit"
                  type="range"
                  min="1000"
                  max="128000"
                  step="1000"
              ...
              <label class="flex items-center gap-2 text-sm text-gray-300 cursor-pointer">
                <input
                  v-model="settings.enableAutoSplit"
                  type="checkbox"
                  class="w-4 h-4 rounded border-gray-600 bg-gray-800 text-blue-500 focus:ring-0"
                />
              ...
              <div v-if="settings.enableAutoSplit" class="ml-6 space-y-3 p-3 bg-gray-800/50 rounded-xl border border-gray-700/30">
                <div>
                  ...
                  <input
                    v-model.number="settings.maxTokensPerChunk"
                    type="number"
                    min="500"
                    max="32000"
                ...
                <div>
                  ...
                  <input
                    v-model.number="settings.overlapTokens"
                    type="number"
                    min="0"
                    max="1000"
                    class="input text-sm py-1.5"
