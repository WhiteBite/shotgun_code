  ...
  <div class="relative">
    ...
    >
      <span class="flex items-center gap-2">
        ...
        <span v-else class="text-indigo-400">{{ selected.length }} {{ selected.length > 1 ? t('filter.types') : t('filter.type') }}</span>
      </span>
    ...
    >
      ...
      <div class="p-2 border-b border-gray-700">
        <input
          v-model="searchQuery"
          type="text"
          :placeholder="t('filter.searchExtensions')"
...
function getExtensionCount(ext: string): number {
