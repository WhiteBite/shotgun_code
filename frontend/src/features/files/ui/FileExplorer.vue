  ...
  <div class="h-full flex flex-col bg-transparent">
            ...
            <div class="relative group">
              ...
              <div class="absolute right-0 top-full mt-2 hidden group-hover:block z-50 px-4 py-3 bg-gray-800/95 backdrop-blur-sm border border-gray-700/50 rounded-xl shadow-2xl whitespace-nowrap">
                <div class="text-xs space-y-1.5">
                  ...
                  <div class="text-gray-400">Progress: <span class="text-indigo-400">{{ selectionProgress }}%</span></div>
    ...
    <div class="p-2 border-b border-gray-700/30 space-y-2">
      ...
      <FileFilterDropdown
        ...
        v-model:selected="filterExtensions"
    ...
    <div class="flex-1 scrollable-y p-2">
      ...
      <div v-else-if="searchQuery && fileStore.searchResults.length > 0">
        ...
        <FileTreeNode
          v-for="node in fileStore.searchResults"
          :key="node.path"
          :node="node"
      ...
      <FileTreeNode
        v-else
        v-for="node in fileStore.filteredNodes.slice(0, 50)"
        :key="node.path"
        :node="node"
        :compact-mode="settingsStore.settings.fileExplorer.compactNestedFolders"
        @toggle-select="handleToggleSelect"
    ...
    <!-- Context Menu -->
    <FileContextMenu
      :node="contextMenu.targetNode.value"
