﻿<template>
  <div v-if="uiStore.isConsoleVisible" class="bg-gray-900 border-t border-gray-700 text-xs font-mono text-gray-300 flex flex-col max-h-[33vh] min-h-[150px] overflow-hidden">
    <div class="flex items-center gap-2 p-2 border-b border-gray-700 flex-wrap">
      <label class="flex items-center gap-1"><input type="checkbox" v-model="filters.levels.debug" /> debug</label>
      <label class="flex items-center gap-1"><input type="checkbox" v-model="filters.levels.info" /> info</label>
      <label class="flex items-center gap-1"><input type="checkbox" v-model="filters.levels.success" /> success</label>
      <label class="flex items-center gap-1"><input type="checkbox" v-model="filters.levels.warning" /> warning</label>
      <label class="flex items-center gap-1"><input type="checkbox" v-model="filters.levels.error" /> error</label>
      <span class="mx-2">|</span>
      <label class="flex items-center gap-1"><input type="checkbox" v-model="filters.autoscroll" /> autoscroll</label>
