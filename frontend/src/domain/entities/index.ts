...
export interface WorkspaceState {
  mode: string;
  panelConfigurations: Record<string, any>;
  switchMode: (mode: string) => void;
  setPanelConfiguration: (panelId: string, config: any) => void;
  getPanelConfiguration: (panelId: string) => any;
  isValidForMode: (mode: string) => boolean;
}
